...
const POST_TYPE_OPTIONS = [
  {
    key: "HELP_REQUEST",
    label: "Help Request",
    description: "Ask for assistance from your community",
  },
  {
    key: "HELP_OFFER",
    label: "Help Offer",
    description: "Offer help to neighbors",
  },
  {
    key: "LOST_FOUND",
    label: "Lost & Found",
  ...
  },
  {
    key: "SAFETY_ALERT",
    label: "Safety Alert",
    description: "Report safety concerns or hazards",
  },
  {
    key: "GENERAL",
    label: "General",
    description: "Share general community updates",
  },
];

const PRIORITY_OPTIONS = [
  { key: "LOW", label: "Low", color: Colors.neutral[500] },
  { key: "NORMAL", label: "Normal", color: Colors.primary[600] },
  { key: "HIGH", label: "High", color: Colors.warning[600] },
  { key: "URGENT", label: "Urgent", color: Colors.error[600] },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Tags ({form.tags.length}/10)</Text>
